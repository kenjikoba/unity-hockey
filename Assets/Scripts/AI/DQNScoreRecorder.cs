...
public class DQNScoreRecorder : MonoBehaviour
{
    ...
    private string scoreDir = "Assets/Records/DQN/";
    private string scorePath; // csvファイルのパス

    // episodeCount番目のepisode後に呼び出し, 記録を更新する
    public void DQNUpdateRecord(int gamecount, int episode, double average_max_q, double score, double average_diff) {
